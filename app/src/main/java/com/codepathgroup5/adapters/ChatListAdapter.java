...
public class ChatListAdapter extends ArrayAdapter<ChatMessagePO> {

    private String mUserId;



    public ChatListAdapter(Context context, String userId, List<ChatMessagePO> messages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ChatMessagePO message = getItem(position);
